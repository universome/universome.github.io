...
og:
  description: A Continuous Video Generator with the Price, Quality and Perks of StyleGAN2
...
common_organizations:
    ...
    - name: Snap Inc.
      ...
      logo: /assets/images/snap-logo.png
informal_summary:
    - >-
...
links:
    pdf: https://github.com/universome/stylegan-v
    arxiv_inactive: true
    github: https://github.com/universome/stylegan-v
# data_host: &data_host https://cvpr2022-stylegan-v.github.io
...
sections:
    ...
    #     - type: text
        ...
        #   caption: "<i>Left</i>: original image. <i>Middle<i>: projected video. <i>Right</i>: editing the image via <b>&laquo;An old person&raquo;</b> text prompt"
        # - type: videos
        #   urls:
        #     - /videos/videos-edit/brad-pitt_projected.mp4
        #     - /videos/videos-edit/brad_pitt_beard.mp4
        #   caption: "<i>Left</i>: original image. <i>Middle<i>: projected video. <i>Right</i>: editing the image via <b>&laquo;An old person&raquo;</b> text prompt"
...
#             <video width=1200 id="teaser-video" style="border: 1px solid black; border-radius: 1px;" preload="auto" src="videos/ffs_256_unstable/ours.m4v" type="video/mp4" autoplay controls loop></video>
#         </div>
